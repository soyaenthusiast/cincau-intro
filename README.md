...
Used to study and crack my head to solve formulas, numbers and ```f(x)-ses``` with no value -- now I use numbers to guide decisions worth thousands of monetary/non-monetary value. 
